...
Version:        %{version}
Release:        1%{?dist}
Summary:        Miniforge3 with latest Python packages
License:        BSD-3-Clause
URL:            https://github.com/conda-forge/miniforge
Source0:        miniforge3-%{version}.tar.gz

%description
Miniforge3 is a minimal installer for conda-forge that provides
the latest Python packages from requirements-latest.txt.
...
- Auto-built RPM with latest Python packages
